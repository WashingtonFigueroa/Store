app.controller('tipo_emisionController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
			...
			colNames:['ID','CÓDIGO','TIPO EMISIÓN','PRINCIPAL','OBSERVACIONES','ESTADO','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'principal',index:'principal', width:60, editable: true, hidden: true, search:false, edittype:"checkbox",editoptions:{value:"Si:No"}},
