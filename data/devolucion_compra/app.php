<?php        
	...
	if ($_POST['btn_guardar'] == "btn_guardar") {
		...
		// guardar devolucion factura compra
		$class->consulta("INSERT INTO factura_compra VALUES  (	'".$id_devolucion."',
																'".$_SESSION['empresa']['id']."',
																'".$_POST['id_proveedor']."',
																'".$_SESSION['user']['id']."',
																'".$id_devolucion."',
		...
		if ($_POST['retencion_fuente'] == "SI") {
			...
			$class->consulta("INSERT INTO retencion_fuente_compra VALUES  (	'".$id_retencion_fuente."',
																			'".$id_devolucion."',
		...
		if ($_POST['retencion_iva'] == "SI") {
			...
			$class->consulta("INSERT INTO retencion_iva_compra VALUES  (	'".$id_retencion_iva."',
																			'".$id_devolucion."',
	    ...
	    for ($i = 1; $i < $nelem; $i++) {
			...
			$class->consulta("INSERT INTO detalle_factura_compra VALUES(	'".$id_detalle_factura."',
																			'".$id_devolucion."',
																			'".$arreglo1[$i]."',
																			'".$arreglo2[$i]."',
																			'".$arreglo3[$i]."',
	...
	if (isset($_POST['llenar_cabezera_factura'])) {
		...
		while ($row = $class->fetch_array($resultado)) {
			$data = array(  'id_devolucion' => $row[0],
							'fecha_actual' => $row[1],
							'hora_actual' => $row[2],
							'serie' => $row[3],
							'id_proveedor' => $row[4],
