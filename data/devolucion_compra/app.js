	    ...
	    jQuery(grid_selector2).jqGrid({	 
	        ...
	        gridComplete: function() {
				...
				for(var i = 0;i < ids.length;i++) {
					...
					pdf = "<a onclick=\"angular.element(this).scope().methodspdf('"+id_factura+"')\" title='Reporte Devolución Compra'><i class='fa fa-file-pdf-o red2' style='cursor:pointer; cursor: hand'> PDF</i></a>"; 
