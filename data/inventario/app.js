app.controller('inventarioController', function ($scope, $interval) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector2).jqGrid({	 
	    	datatype: "xml",
		    url: 'data/proformas/xml_inventario.php', 
	        ...
	        gridComplete: function() {
				...
				for(var i = 0;i < ids.length;i++) {
					...
					pdf = "<a onclick=\"angular.element(this).scope().methodspdf('"+id_proforma+"')\" title='Reporte Inventario' ><i class='fa fa-file-pdf-o red2' style='cursor:pointer; cursor: hand'> PDF</i></a>"; 
