	...
	jQuery(function($) {
		...
		$('#form_productos').validate({
			...
			messages: {
				...
				select_categoria: {
					required: "Por favor, Indique una Categoria",
				},
				select_bodega: {
					required: "Por favor, Indique una Bodega",
				},
				select_medida: {
					required: "Por favor, Indique Unidad de Medida",
				},
				select_marca: {
					required: "Por favor, Indique una Marca",
				},
				select_tipo: {
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        ondblClickRow: function(rowid) {     	            	            
	            	...
	            	$("#logo").attr("src", "data/productos/"+ ret.foto);
