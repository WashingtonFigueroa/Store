								...
								if(filas.length == 0) {
					                ...
					                $.ajax({
					                    ...
					                    success: function(data) {
					                    	...
					                    	bootbox.alert("Gracias! Por su Información Nota de Crédito Agregada Correctamente!", function() {
							        			var myWindow = window.open('data/reportes/nota_credito.php?id='+id,'popup','width=900,height=650');
												location.reload();
											});	
					                    }
	    ...
	    jQuery(grid_selector1).jqGrid({	 
	        ...
	        gridComplete: function() {
				...
				for(var i = 0;i < ids.length;i++) {
					...
					pdf = "<a onclick=\"angular.element(this).scope().methodspdf('"+id_factura+"')\" title='Reporte Nota Crédito' ><i class='fa fa-file-pdf-o red2' style='cursor:pointer; cursor: hand'> PDF</i></a>"; 
