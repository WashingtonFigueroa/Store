<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(150, 5, "EGRESO", 0,1, 'R', 0);      
    ...
    $resultado = $class->consulta("SELECT E.origen, E.destino, E.fecha_actual, E.tarifa0, E.tarifa, E.iva, E.total_descuento, E.total_egreso FROM egreso E WHERE id = '".$_GET['id']."'");        
