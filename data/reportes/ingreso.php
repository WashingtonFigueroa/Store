<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(150, 5, "INGRESO", 0,1, 'R', 0);      
    ...
    $resultado = $class->consulta("SELECT I.origen, I.destino, I.fecha_actual, I.tarifa0, I.tarifa, I.iva, I.total_descuento, I.total_ingreso FROM ingreso I WHERE id = '".$_GET['id']."'");        
